...
const timer_schema_1 = require("./timer.schema");
const users_schema_1 = require("../users/users.schema");
const ApiError_1 = __importDefault(require("../../../errors/ApiError"));
const http_status_1 = __importDefault(require("http-status"));
const updateOrCreateTimer = (payload, id, token) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let result = yield timer_schema_1.Timer.findByIdAndUpdate({ _id: id }, payload, {
        new: true,
    });
    return result;
});
const getUpcomingTime = () => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield timer_schema_1.Timer.find({});
    return result;
});
